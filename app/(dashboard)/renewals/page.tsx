...
export default async function RenewalsPage({ searchParams }: { searchParams: Promise<{ q?: string; platform?: string; slot?: string; payment?: string; from?: string; to?: string }> }) {
  const { q = "", platform = "", slot = "", payment: method = "", from = "", to = "" } = await searchParams;
