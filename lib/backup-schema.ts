...
export const backupSchema = z.object({
  ...
  slots: z.array(z.object({ id: z.string(), platformId: z.string(), slotNumber: z.number().int(), accountEmail: z.string(), encryptedPassword: z.string(), encryptedVerificationUrl: z.string().nullable().optional(), cardLast4: z.string().nullable(), billingDay: z.number().int(), capacity: z.number().int(), status, note: z.string().nullable(), createdAt: date, updatedAt: date })),
